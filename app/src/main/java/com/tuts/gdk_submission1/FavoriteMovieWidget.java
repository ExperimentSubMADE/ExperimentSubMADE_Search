...
public class FavoriteMovieWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.tuts.gdk_submission1.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.tuts.gdk_submission1.EXTRA_ITEM";
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setEmptyView(R.id.stackWidget, R.id.txtWidgetEmptyTitle);
        ...
        views.setPendingIntentTemplate(R.id.stackWidget, toastPendingIntent);
